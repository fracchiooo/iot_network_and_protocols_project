...
extern const uint8_t server_cert_start[] asm("_binary_server_pem_start");
extern const uint8_t server_cert_end[] asm("_binary_server_pem_end");
...
extern const uint8_t client_key_pem_start[] asm("_binary_clientkey_pem_start");
extern const uint8_t client_key_pem_end[] asm("_binary_clientkey_pem_end");
